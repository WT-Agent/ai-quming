    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">八字起名与品牌取名</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 八字起名与品牌取名助手</span>
...
// 清理回复末尾的特殊标记 [QUMING_SCORES]...[/QUMING_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[QUMING_SCORES\][\s\S]*?\[\/QUMING_SCORES\]/gi, '').trim();
});
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - 八字起名与企业品牌取名专家】\n\n${cleanContent.value}\n\n体验起名AI助手：https://ai.wuxian.xyz`;
